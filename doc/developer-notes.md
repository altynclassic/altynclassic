...
Altynclassic Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Altynclassic Core, where everyone uses
...
pay attention to for reviewers of Altynclassic Core code.

General Altynclassic Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Altynclassic Core uses tinyformat, which is type safe. Leave them out to avoid confusion
