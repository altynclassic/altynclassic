...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Altynclassic Core altynclassic-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  altynclassic-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded altynclassic transaction") + "\n" +
              "  altynclassic-tx [options] -create [commands]   " + _("Create hex-encoded altynclassic transaction") + "\n" +
              "\n";
