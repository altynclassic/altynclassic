...
Contains files used to package altynclassicd/altynclassic-qt
for Debian-based Linux systems. If you compile altynclassicd/altynclassic-qt yourself, there are some useful files here.
